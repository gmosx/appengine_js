...
//    ctor.__proto__ = this; // disabled in ringojs, use this alternative:
    ...
    ctor._properties = OBJECT.merge(this.properties(), _initializeProperties(ctor, properties));
...
Model.updateProperties = function (newProperties) {
    this._properties = OBJECT.merge(this._properties, _initializeProperties(this, newProperties));    
}
