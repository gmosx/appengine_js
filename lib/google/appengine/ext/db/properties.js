...
UserProperty.prototype.getValueForDatastore = function (obj) {
	// TODO guard the following with:
	// if (obj.autoCurrentUser || obj.autoCurrentUserAdd)
	// and figure out what to do when none of these options is set.
	return users.UserService.getCurrentUser();
}
