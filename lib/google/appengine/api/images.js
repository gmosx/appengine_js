...
var Image = exports.Image = function(imageData) {
    this.oldImage = JImagesServiceFactory.makeImage(imageData._bytes);
...
Image.prototype.resize = function(width, height) {
    this.transform.concatenate(JImagesServiceFactory.makeResize(width, height));
    return this;
}
...
Image.prototype.executeTransforms = function(outputEncoding) {
    ...
    var newImage = jservice.applyTransform(this.transform, this.oldImage, outputEncoding);
