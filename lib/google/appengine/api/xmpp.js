 ...
 * Example usage:
 *
 * Map the following JSGI app at _ah/xmpp/message/chat
 *
...
exports.getPresence = function(jid, fromJid) {
    var presense = fromJid ? jservice.getPresence(new JJID(jid)) : jservice.getPresense(new JJID(jid), new JJID(fromJid));
    return presense.isAvailable();    
}
...
exports.sendMessage = function(jids, body, fromJid, messageType, rawXML) {
    ...
    if (fromJid) mb = mb.withFromJid(fromJid);
...
var Message = exports.Message = function(env) {
    ...
    this.sender = String(jmsg.getFromJid());        
//    this.to = String(jmsg.getRecipientJids);
...
Message.prototype.reply = function(body, messageType, rawXML, sendMessage) {
    (sendMessage || exports.sendMessage)(this.sender, body, this.to, messageType, rawXML);
}
